			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-xs-6">
							...
							<div class="col-xs-4">
								<select class="quantity" data-id="{{ $row->rowId }}" value="{{ $row->qty }}">
									@for($i = 1; $i < 99 + 1 ; $i++)
				...
				<div class="panel-footer">
					<div class="row text-center">
						<div class="col-xs-3">
							<h4 class="text-right">Subtotal <strong><br>
								{{ presentPrice(Cart::subtotal()) }}</strong></h4>
							</div>
						<div class="col-xs-3">
						<h4 class="text-right">Tax <strong><br>
								{{ presentPrice(Cart::tax()) }}</strong></h4>
						</div>
						<div class="col-xs-3">
